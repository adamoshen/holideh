...
working with business days and Canadian holidays, including wrappers for
the [Canada Holidays API](https://canada-holidays.ca).
...
- [`is_weekend()`](https://adamoshen.github.io/holideh/reference/off_day.md):
  Given a vector of dates, detects whether the supplied dates are a
  weekend (typically Saturday or Sunday, but can be modified).
...
`FALSE`), they can be used in conjunction with
